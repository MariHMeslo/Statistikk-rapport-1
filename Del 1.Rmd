...
# To make this work you need to have the data in the same repository 
# as where you have the code. Below you say that the data is in the 
# subfolder "data" but there is no folder by that name in your repositiory

# to download the data:

# I comment it out as you oinly need to do it once
# download.file(url = "https://ndownloader.figstatic.com/files/14702420", destfile = 
# "./data/hypertrophy.csv")
